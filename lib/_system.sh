...
#######################################
# Clonar repositório usando o git
# Arguments:
#   None
#######################################
system_git_clone() {
  print_banner
  printf "${WHITE} 💻 Fazendo download do código Git...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${WHITE} 💻 Bloquear o sistema...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Desbloquear o sistema...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${WHITE} 💻 Alterar os Dominios...${GRAY_LIGHT}"
  printf "\n\n"
...
system_node_install() {
  print_banner
  printf "${WHITE} 💻 Instalando Node.js e Yarn...${GRAY_LIGHT}"
  printf "\n\n"
  ...
  # Instalando Yarn
  curl -sL https://dl.yarnpkg.com/debian/pubkey.gpg | gpg --dearmor | sudo tee /usr/share/keyrings/yarn-archive-keyring.gpg >/dev/null
  echo "deb [signed-by=/usr/share/keyrings/yarn-archive-keyring.gpg] https://dl.yarnpkg.com/debian stable main" | sudo tee /etc/apt/sources.list.d/yarn.list
  sudo apt-get update && sudo apt-get install -y yarn

  # Instalando MariaDB Client
...
EOF
  ...
  # Instalando pacotes no backend com Yarn
  sudo su - deploy <<EOF
...
system_docker_install() {
  ...
  # Adicionando chave do repositório do Docker
  curl -fsSL https://download.docker.com/linux/ubuntu/gpg | gpg --dearmor -o /usr/share/keyrings/docker-archive-keyring.gpg

  # Configurando repositório do Docker
  ...
  # Atualizando e instalando Docker com o Yarn
  apt-get update && apt-get install -y yarn docker-ce docker-ce-cli containerd.io
...
system_puppeteer_dependencies() {
  print_banner
  printf "${WHITE} 💻 Instalando dependências do Puppeteer com yarn...${GRAY_LIGHT}"
  printf "\n\n"
  ...
  # Instalando as dependências do Puppeteer com yarn
  yarn global add libxshmfence-dev \
                      libgbm-dev \
                      wget \
                      unzip \
                      fontconfig \
...
system_nginx_restart() {
  print_banner
  printf "${WHITE} 💻 Reiniciando o serviço Nginx...${GRAY_LIGHT}"
  printf "\n\n"
...
#######################################
# cria um arquivo de configuração chamado deploy.conf 
# Arguments:
#   None
#######################################
system_nginx_conf() {
...
# example_directive valor;
# outra_directive valor;
END
