...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador do app Yollo, selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar Yollo\n"
  printf "   [1] Atualizar Yollo\n"
  printf "   [2] Deletar Yollo\n"
  printf "   [3] Bloquear Yollo\n"
  printf "   [4] Desbloquear Yollo\n"
  printf "   [5] Alter. dominio Yollo\n"
  printf "\n"
  read -p "> " option
